...
public class SciConstants {
	...
	public static final double C = 299792458; // m/s - Speed of light in vacuum
	public static final double MU_0 = (4 * Math.PI) * 1e-7; // N/A^2 - Magnetic permeability
	public static final double E = 1.6021765314e-19; // C - Elementary charge
